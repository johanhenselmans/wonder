...
with (Control.DatePicker) {
	...
	Locale['nl_NL'] = i18n.createLocale('nl', 'nl');
	Locale['fr_FR'] = i18n.createLocale('fr', 'fr');
	Locale['lt_LT'] = i18n.createLocale('lt', 'lt');
	Locale['pl_PL'] = i18n.createLocale('pl', 'pl');
	Locale['pt_BR'] = i18n.createLocale('br', 'pt');;
}
